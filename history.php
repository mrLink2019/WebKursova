...
<div class="row">
    ...
    <div class="col-md-2">Назва</div>
    <div class="col-md-1">Звідки</div>
    <div class="col-md-1">Куди</div>
    <div class="col-md-2">Час відбуття</div>
    <div class="col-md-2">Час прибуття</div>
    <div class="col-md-1">Дата поїздки</div>
    <div class="col-md-1">Ціна (грн)</div>
    <div class="col-md-1">К-сть місць</div>
</div>
<?php

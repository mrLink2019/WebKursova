...
<div class="container">
    ...
    <div class="row mb-2">
    <h4 class="col-md-3">Користувачі</h4>
    ...
    <form method="post" action="">
        ...
        <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> Пошук</button>
    </form>
    </div>
</div>
<div class="table-con">
<div class="row">
    ...
    <div class="col-md-1">Гендер</div>
    <div class="col-md-1">Тип</div>
    <div class="col-md-2">Адреса</div>

...
<tr>
	...
	<td width="30%">
		<?php
			if ($acc!="") {
				if ($acc == "ok") {
					echo '<div class="alert alert-success">Аккаунт створено!</div>';
				}
				else {
		...
		?>
		<h4 class="my-3">Створити аккаунт</h4>
	    ...
	    <div class="form-group row">
	      <label for="upass" class="col-sm-2 col-form-label">Пароль</label>
	      <div class="col-sm-7">
	    ...
	    <div class="form-group row">
	      <label class="col-form-legend col-sm-2" for="utype">Тип користувача</label>
	      <div class="col-sm-7 px-5">
	    ...
	    <div class="form-group row">
	      <div class="offset-sm-2 col-sm-10">
	        <button type="submit" class="btn btn-primary" name="signup">Зареєструватись</button>
	      </div>
	    </div>
		<script async>

  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Додати автобус</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
            <div class="col-sm-3">Прибуття</div>
                <div class="col-sm-8">
                    <input type="text" name="to_time" class="form-control"/>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3">Ціна/квиток</div>
                <div class="col-sm-8">
      ...
      <div class="modal-footer">
        ...
        <a href="my_buses.php"><button type="button" class="btn btn-secondary" data-dismiss="modal">Скасувати</button></a>
      </div>
      </form>
    </div>
  </div>
...
?>
<div class="row mb-2">
    <h4 class="col-md-3">Мої автобуси</h4>
    <div class="col-md-8 text-right ml-4">
        <a href="my_buses.php?act=add"><button type="button" class="btn btn-sm btn-primary">+ Додати автобус</button></a>
    </div>
</div>

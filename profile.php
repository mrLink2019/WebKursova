  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Змінити профіль</h5>
      ...
      <div class="modal-body">
	    ...
	    <div class="form-group row">
	      <label for="upass" class="col-sm-2 col-form-label">Новий пароль</label>
	      <div class="col-sm-7">
	        <input name="password" type="password" class="form-control" id="inputPassword" placeholder="Залишіть пустим для старого">
	      </div>
		  <div class="col-sm-2" id="infoPass"></div>
	    </div>
	    <div class="form-group row">
	      <label class="col-form-legend col-sm-2" for="gender">Гендер</label>
		...
		<div class="form-group row">
	      <label for="mobile" class="col-sm-2 col-form-label">Телефон</label>
      ...
      <div class="modal-footer">
        <input type="submit" id="submitButton" class="btn btn-primary" value="Підтвердити" name="edit"/>
...
<div class="form-group row">
	    ...
	    <div class="form-group row">
	      <label class="col-form-legend col-sm-2" for="utype">Тип</label>
	      <div class="col-sm-9">
	    ...
	    <div class="form-group row">
	      <div class="offset-sm-2 col-sm-10">
	        <button id="editButton" class="btn btn-primary" onclick="$('#editModal').show()">Змінити профіль</button>
	      </div>
	    </div>
<br>
<?php
